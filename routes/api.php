    ...
    Route::middleware(['auth:sanctum', 'erp.tenant', 'erp.session_idle', 'erp.password_expiry', 'throttle:api'])->group(function () {
        ...
        Route::middleware(['erp.module:admin'])->group(function () {
            ...
            Route::apiResource('kra-responses', KraResponseController::class)
                ->middleware('erp.permission:admin.kra_responses.view|admin.view|reports.kra_receipts.view|pricing_tax.kra_invoices.view');
        });
        ...
        Route::apiResource('branches', BranchController::class)
            ->only(['index', 'show'])
            ->middleware([
                'erp.module:admin,hr_payroll,sales,inventory,accounting,distribution,customers_suppliers',
