...
use App\Http\Controllers\Api\V1\LpoSupplierReturnController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('supplier-payments', [SupplierPaymentController::class, 'indexAll']);
        ...
        Route::get('supplier-return-documents/{supplier_return_document}', [SupplierReturnDocumentController::class, 'show']);
        Route::put('supplier-return-documents/{supplier_return_document}', [SupplierReturnDocumentController::class, 'update']);
        Route::delete('supplier-return-documents/{supplier_return_document}', [SupplierReturnDocumentController::class, 'destroy']);
        Route::post('supplier-return-documents/{supplier_return_document}/approve', [SupplierReturnDocumentController::class, 'approve']);
        Route::post('supplier-return-documents/{supplier_return_document}/reject', [SupplierReturnDocumentController::class, 'reject']);
        ...
        Route::get('supplier-returns/{supplier_return}', [SupplierReturnController::class, 'show']);
        ...
        Route::get('lpo-mst/{lpo_mst}/summary', [LpoMstController::class, 'summary']);
        Route::post('lpo-mst/{lpo_mst}/workflow', [LpoMstController::class, 'workflow']);
        Route::get('lpo-mst/{lpo_mst}/supplier-returns', [LpoSupplierReturnController::class, 'index']);
        Route::post('lpo-mst/{lpo_mst}/supplier-returns', [LpoSupplierReturnController::class, 'store']);
        Route::post('lpo-mst/full', [LpoMstController::class, 'storeFull']);
        Route::put('lpo-mst/{lpo_mst}/full', [LpoMstController::class, 'updateFull']);
