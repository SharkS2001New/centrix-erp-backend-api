...
class OrganizationCache
{
    ...
    {
        // m3: rebuild maps after HR time-attendance page grants (absents, missed punches, …).
        return 'capabilities:m3:v'.self::capabilitiesVersion($organizationId).':user:'.$userId;
    }
