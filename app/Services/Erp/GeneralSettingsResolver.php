...
class GeneralSettingsResolver
{
    ...
    /** @var array<string, array{family: string, scale: string, size_px: int}> */
    public const PRINT_FONT_VARIANT_DEFAULTS = [
        'receipt' => ['family' => 'arial', 'scale' => 'standard', 'size_px' => 11],
        'invoice' => ['family' => 'times', 'scale' => 'standard', 'size_px' => 14],
        'lpo' => ['family' => 'times', 'scale' => 'standard', 'size_px' => 14],
        'loading_sheet' => ['family' => 'arial', 'scale' => 'standard', 'size_px' => 16],
        'report' => ['family' => 'times', 'scale' => 'standard', 'size_px' => 14],
    ];
