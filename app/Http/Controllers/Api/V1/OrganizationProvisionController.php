...
class OrganizationProvisionController extends Controller
{
    ...
    protected function salesPlatformRules(): array
    {
        ...
        return [
            ...
            'sales_platform.stock_deduct_on.pos' => 'sometimes|in:order_created,order_completed,trip_load,trip_depart',
            'sales_platform.stock_deduct_on.mobile' => 'sometimes|in:order_created,order_completed,trip_load,trip_depart',
            'sales_platform.stock_deduct_on.backend' => 'sometimes|in:order_created,order_completed,trip_load,trip_depart',
