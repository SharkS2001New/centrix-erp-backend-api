...
class OrganizationProvisionController extends Controller
{
    ...
    protected function salesPlatformRules(): array
    {
        ...
        return [
            ...
            'sales_platform.enable_mobile_orders_expenses_card' => 'sometimes|boolean',
            ...
            'sales_platform.backoffice_product_search_mode' => 'sometimes|in:live,indexeddb',
            ...
            'sales_platform.classic_pos_theme_template' => 'sometimes|string|in:'.implode(',', \App\Services\Sales\ClassicPosThemeSettings::THEME_TEMPLATES),
            'sales_platform.classic_pos_theme_colors' => 'sometimes|array',
            'sales_platform.classic_pos_theme_colors.workspace' => 'sometimes|nullable|string|max:9',
            'sales_platform.classic_pos_theme_colors.header' => 'sometimes|nullable|string|max:9',
            'sales_platform.classic_pos_theme_colors.footer' => 'sometimes|nullable|string|max:9',
            'sales_platform.classic_pos_theme_colors.button' => 'sometimes|nullable|string|max:9',
            'sales_platform.classic_pos_theme_colors.select' => 'sometimes|nullable|string|max:9',
            'sales_platform.erp_theme_template' => 'sometimes|string|in:'.implode(',', \App\Services\Sales\ClassicPosThemeSettings::THEME_TEMPLATES),
            'sales_platform.erp_theme_colors' => 'sometimes|array',
            'sales_platform.erp_theme_colors.workspace' => 'sometimes|nullable|string|max:9',
            'sales_platform.erp_theme_colors.header' => 'sometimes|nullable|string|max:9',
            'sales_platform.erp_theme_colors.footer' => 'sometimes|nullable|string|max:9',
            'sales_platform.erp_theme_colors.button' => 'sometimes|nullable|string|max:9',
            'sales_platform.erp_theme_colors.select' => 'sometimes|nullable|string|max:9',
            'sales_platform.external_pos_theme_template' => 'sometimes|string|in:'.implode(',', \App\Services\Sales\ClassicPosThemeSettings::THEME_TEMPLATES),
            'sales_platform.external_pos_theme_colors' => 'sometimes|array',
            'sales_platform.external_pos_theme_colors.workspace' => 'sometimes|nullable|string|max:9',
            'sales_platform.external_pos_theme_colors.header' => 'sometimes|nullable|string|max:9',
            'sales_platform.external_pos_theme_colors.footer' => 'sometimes|nullable|string|max:9',
            'sales_platform.external_pos_theme_colors.button' => 'sometimes|nullable|string|max:9',
            'sales_platform.external_pos_theme_colors.select' => 'sometimes|nullable|string|max:9',
            ...
            'sales_platform.hospitality_services.front_desk' => 'sometimes|boolean',
            'sales_platform.hospitality_services.folios' => 'sometimes|boolean',
            'sales_platform.hospitality_services.housekeeping' => 'sometimes|boolean',
            'sales_platform.hospitality_services.night_audit' => 'sometimes|boolean',
            'sales_platform.hospitality_services.extra_outlets' => 'sometimes|boolean',
            'sales_platform.hospitality_services.floor_tables' => 'sometimes|boolean',
            'sales_platform.hospitality_services.table_pos' => 'sometimes|boolean',
            'sales_platform.hospitality_services.room_charge' => 'sometimes|boolean',
            'sales_platform.hospitality_payment_workflow' => 'sometimes|array',
            'sales_platform.hospitality_payment_workflow.unpaid' => 'sometimes|boolean',
            ...
            'sales_platform.hotel_pos_payment_methods' => 'sometimes|array',
            'sales_platform.hotel_pos_payment_methods.cash' => 'sometimes|boolean',
            'sales_platform.hotel_pos_payment_methods.mpesa' => 'sometimes|boolean',
            'sales_platform.hotel_pos_payment_methods.equity' => 'sometimes|boolean',
            'sales_platform.hotel_pos_payment_methods.kcb' => 'sometimes|boolean',
            'sales_platform.hotel_pos_payment_methods.other_bank' => 'sometimes|boolean',
            'sales_platform.hotel_pos_payment_methods.cheque' => 'sometimes|boolean',
            'sales_platform.hotel_pos_payment_methods.extra' => 'sometimes|boolean',
            'sales_platform.enable_pos_order_edit' => 'sometimes|boolean',
            'sales_platform.enable_held_order_amount_paid' => 'sometimes|boolean',
            ...
            'sales_platform.enable_receive_batch_tracking' => 'sometimes|boolean',
            ...
            'sales_platform.convert_to_paid_statuses' => 'sometimes|array',
            'sales_platform.convert_to_paid_statuses.*' => ['required', 'string', $actionStageRule],
            'sales_platform.convert_to_unpaid_statuses' => 'sometimes|array',
            'sales_platform.convert_to_unpaid_statuses.*' => ['required', 'string', $actionStageRule],
            ...
            'sales_platform.shop_debtors_default_days' => 'sometimes|integer|min:1|max:90',
