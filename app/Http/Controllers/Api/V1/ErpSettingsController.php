...
class ErpSettingsController extends Controller
{
    ...
    public function updateSales(Request $request)
    {
        ...
        $salesKeys = [
            ...
            'proforma_vat_note',
            'show_proforma_signatures',
            'proforma_confirmed_by',
            'show_proforma_banner',
            'proforma_banner_text',
            'show_proforma_customer_pin',
            'show_proforma_our_pin',
        ...
        $rules = [
            ...
            'stock_deduct_on.pos' => 'sometimes|in:order_created,order_completed,trip_pick,trip_load,trip_depart',
            ...
            'reports_default_date_range_days' => 'sometimes|integer|min:1|max:90',
            'shop_debtors_default_days' => 'sometimes|integer|min:1|max:90',
            ...
            'proforma_vat_note' => 'sometimes|nullable|string|max:500',
            'show_proforma_signatures' => 'sometimes|boolean',
            'proforma_confirmed_by' => 'sometimes|nullable|string|max:120',
            'show_proforma_banner' => 'sometimes|boolean',
            'proforma_banner_text' => 'sometimes|nullable|string|max:500',
            'show_proforma_customer_pin' => 'sometimes|boolean',
            'show_proforma_our_pin' => 'sometimes|boolean',
        ...
        if (array_key_exists('shop_debtors_default_days', $data)) {
            $nextSales['shop_debtors_default_days'] = $this->platformConfig->normalizeShopDebtorsDefaultDays(
                $data['shop_debtors_default_days'],
            );
        }
        if (array_key_exists('reports_default_date_range_days', $data)) {
            $nextSales['reports_default_date_range_days'] = $this->platformConfig->normalizeReportsDefaultDateRangeDays(
                $data['reports_default_date_range_days'],
            );
        }
    ...
    public function updateFinance(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'mpesa.enable_c2b_reconciliation' => 'sometimes|boolean',
            'mpesa.auto_apply_order_reference' => 'sometimes|boolean',
            'mpesa.payment_account_name' => 'sometimes|nullable|string|max:80',
            'mpesa.payment_account_hint' => 'sometimes|nullable|string|max:250',
            ...
            'equity.payment_account_name' => 'sometimes|nullable|string|max:80',
    ...
    public function updateNotifications(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'order_placed_scope' => 'sometimes',
            'order_placed_scope.*' => 'sometimes|in:all,mobile,debtors,route_orders',
            'notify_on_debtor_payment' => 'sometimes|boolean',
            'debtor_payment_scope' => 'sometimes',
            'debtor_payment_scope.*' => 'sometimes|in:all,mobile,debtors,route_orders',
            'notify_on_debt_reminder' => 'sometimes|boolean',
            'debt_reminder_after_days' => 'sometimes|integer|min:1|max:365',
            'debt_reminder_scope' => 'sometimes',
            'debt_reminder_scope.*' => 'sometimes|in:all,mobile,debtors,route_orders',
            ...
            'debt_reminder_sms_template' => 'sometimes|nullable|string|max:500',
            'debt_reminder_email_template' => 'sometimes|nullable|string|max:500',
    ...
    public function updateHr(Request $request)
    {
        ...
        $rules = [
            ...
            'default_lunch_minutes' => 'sometimes|integer|min:0|max:240',
            'default_lunch_required' => 'sometimes|boolean',
            'lunch_break_is_paid' => 'sometimes|boolean',
