...
/**
 * Sales by User: add COGS and gross profit (gross sales − COGS) per cashier/channel/day.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $this->rebuildView(withGrossProfit: true);
    }
    ...
    public function down(): void
    {
        ...
        $this->rebuildView(withGrossProfit: false);
    }

    protected function rebuildView(bool $withGrossProfit): void
    {
