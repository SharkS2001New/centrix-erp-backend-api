    ...
    'groups' => [
        ...
        'pos' => [
            ...
            'features' => [
                ...
                'payments_breakdown' => ['label' => 'Payments breakdown', 'actions' => ['view']],
            ],
        ],
        'hotel_bar_pos' => [
            'label' => 'Hotel POS',
        ...
        'hospitality' => [
            ...
            'features' => [
                ...
                'orders' => ['label' => 'F&B orders', 'actions' => ['view']],
                'payments_breakdown' => ['label' => 'Payments breakdown', 'actions' => ['view']],
        ...
        'reports' => [
            ...
            'features' => [
                ...
                'sales_by_product' => ['label' => 'Sales by product', 'actions' => ['view']],
                'sales_by_supplier' => ['label' => 'Sales by supplier', 'actions' => ['view']],
                'sales_by_user' => ['label' => 'Sales by user', 'actions' => ['view']],
                'sales_by_customer' => ['label' => 'Sales by customer', 'actions' => ['view']],
                'sales_by_channel' => ['label' => 'Sales by channel', 'actions' => ['view']],
                'sales_pipeline' => ['label' => 'Sales pipeline', 'actions' => ['view']],
                'category_sales' => ['label' => 'Category sales', 'actions' => ['view']],
                // Distribution
                ...
                'credit_outstanding' => ['label' => 'Credit outstanding', 'actions' => ['view']],
                'top_debtors' => ['label' => 'Top debtors', 'actions' => ['view']],
                'invoice_payments' => ['label' => 'Invoice payments', 'actions' => ['view']],
                'customer_statement' => ['label' => 'Customer statement', 'actions' => ['view']],
                // Inventory
                'stock_on_hand' => ['label' => 'Stock on hand', 'actions' => ['view']],
                'low_stock' => ['label' => 'Low stock', 'actions' => ['view']],
                'stock_movement' => ['label' => 'Stock movement', 'actions' => ['view']],
                'stock_chain' => ['label' => 'Stock chain', 'actions' => ['view']],
                'stock_valuation' => ['label' => 'Stock valuation', 'actions' => ['view']],
                'stock_reservations' => ['label' => 'Stock reservations', 'actions' => ['view']],
                ...
                'stock_receipts' => ['label' => 'Stock receipts', 'actions' => ['view']],
                'supplier_returns' => ['label' => 'Supplier returns report', 'actions' => ['view']],
                'damages' => ['label' => 'Damages report', 'actions' => ['view']],
                // POS
                'eod_cashier' => ['label' => 'EOD by cashier', 'actions' => ['view']],
                'eod_report' => ['label' => 'End of day report', 'actions' => ['view']],
                'till_sessions' => ['label' => 'Till sessions', 'actions' => ['view']],
                'discount_summary' => ['label' => 'Discount summary', 'actions' => ['view']],
                'payment_collection' => ['label' => 'Payment collection', 'actions' => ['view']],
        ...
        'hr' => [
            ...
            'features' => [
                ...
                'attendance' => ['label' => "Today's attendance", 'actions' => ['view']],
                'manual_attendance' => ['label' => 'Add Manual attendance', 'actions' => ['create']],
                'attendance_history' => ['label' => 'Previous attendance', 'actions' => ['view']],
                'missed_punches' => ['label' => 'Missed punches', 'actions' => ['view']],
                'duplicate_punches' => ['label' => 'Duplicate punches', 'actions' => ['view']],
                'absents' => ['label' => 'Absents', 'actions' => ['view']],
                'lateness' => ['label' => 'Lateness', 'actions' => ['view']],
                'leave' => ['label' => 'Leave', 'actions' => ['view', 'create', 'edit', 'approve']],
                'shifts' => ['label' => 'Shifts', 'actions' => ['view', 'create', 'edit', 'delete']],
                'pending_overtime' => ['label' => 'Pending overtimes', 'actions' => ['view', 'approve']],
