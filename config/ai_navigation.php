...
return [
    'sections' => [
        ...
        [
            ...
            'module' => 'reports',
            'items' => [
                ['label' => 'All reports', 'path' => '/reports', 'module' => 'reports', 'permission' => 'reports.hub.view'],
                ...
                ['label' => 'HR dashboard KPIs', 'path' => '/reports/hr-dashboard-kpi', 'module' => 'hr_payroll.reports', 'permission' => 'hr.employees.view'],
            ],
        ],
        [
            'id' => 'settings',
            ...
            'items' => [
                ['label' => 'Admin overview', 'path' => '/admin', 'module' => 'admin', 'permission' => 'admin.overview.view'],
                ['label' => 'System preferences', 'path' => '/admin/settings', 'module' => 'admin', 'permission' => 'admin.settings.view'],
                ['label' => 'Users', 'path' => '/admin/users', 'module' => 'admin', 'permission' => 'admin.users.view', 'requires_admin' => true],
                ['label' => 'Roles & permissions', 'path' => '/admin/roles', 'module' => 'admin', 'permission' => 'admin.roles.view'],
            ],
        ],
    ],
    'actions' => [
