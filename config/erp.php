    ...
    */
    ...
    'module_settings_defaults' => [
        ...
        'sales' => [
            ...
            'proforma_print_terms' => "Order valid for the period shown above.\nNo goods shall be received without an invoice or delivery note.\nPlease quote invoice number on all delivery notes.\nKindly attach a copy of this invoice to delivery notes.\nNo oversupply will be accepted.\nEnsure KRA PIN is captured on all supplier invoices.\nGoods must comply with applicable KEBS standards.\nVAT amount will not be paid on invoices without ETR receipt.\nPayment terms as agreed with the customer.",
            'show_proforma_vat_note' => true,
            'proforma_vat_note' => '*The above prices are inclusive of VAT',
            'show_proforma_signatures' => true,
            'proforma_confirmed_by' => '',
            'show_proforma_banner' => true,
            'proforma_banner_text' => 'This is a proforma invoice for payment purposes — not a tax invoice.',
        ...
        'general' => [
            ...
            'print_logo_receipt_show' => true,
            'print_logo_receipt_position' => 'center',
            'print_logo_receipt_size' => 'small',
            'print_logo_invoice_show' => true,
            'print_logo_invoice_position' => 'right',
            'print_logo_invoice_size' => 'large',
            'print_logo_proforma_show' => true,
            'print_logo_proforma_position' => 'right',
            'print_logo_proforma_size' => 'small',
            'print_logo_lpo_show' => true,
            'print_logo_lpo_position' => 'right',
            'print_logo_lpo_size' => 'medium',
            'print_logo_loading_sheet_show' => true,
            'print_logo_loading_sheet_position' => 'center',
            'print_logo_loading_sheet_size' => 'medium',
            'print_logo_picking_list_show' => true,
            'print_logo_picking_list_position' => 'center',
            'print_logo_picking_list_size' => 'medium',
            'print_logo_trip_chart_show' => true,
            'print_logo_trip_chart_position' => 'center',
            'print_logo_trip_chart_size' => 'medium',
            'print_logo_payroll_receipt_show' => true,
            'print_logo_payroll_receipt_position' => 'center',
            'print_logo_payroll_receipt_size' => 'medium',
