...
return [
    ...
    'applications' => [
        ...
        'manager' => [
            ...
            'standalone' => true,
            // Reports appear here so Field Manager roles can be granted without
            // hunting under Backoffice / Accounting. Same permission codes as those apps.
            'registry_modules' => ['mobile_manager', 'reports'],
            'module_features' => [
                'reports' => [
                    'hub',
                    'daily_sales',
        ...
        'backoffice' => [
            ...
            // Sale payments: collect / complete remaining balances on sales orders (not AR invoices).
