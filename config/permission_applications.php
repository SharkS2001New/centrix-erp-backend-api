...
return [
    ...
    'applications' => [
        ...
        'distribution' => [
            'label' => 'Distribution',
            'description' => 'Drivers, vehicles, routes, dispatch, shop debtors, and logistics reports.',
            'registry_modules' => ['fulfillment', 'customers', 'shop_debtors', 'sales', 'pos', 'reports'],
            'module_features' => [
                'customers' => ['customers', 'statements'],
                'sales' => [
                    'orders',
                    ...
                    'order_queue_all',
                    'order_queue_unpaid',
                    'order_queue_pending_payment',
                    'order_queue_paid',
                    'order_queue_completed',
                    'returns',
                ],
                'pos' => ['till_management', 'end_of_day', 'payments_breakdown'],
                'reports' => [
